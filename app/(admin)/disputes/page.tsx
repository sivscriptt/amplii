...
const mockDisputes: Dispute[] = [
  { id: "1", gig: "Summer Brunch Promo", opened_by: "The Rooftop Cafe", opened_by_role: "business", against: "@sarah.creates", reason: "Content quality doesn't match requirements", details: "The reel is only 8 seconds long and doesn't show the food at all. The brief required at least 30 seconds with food close-ups.", status: "open", opened_at: "2h ago", assigned_admin: null, resolution_notes: null },
  { id: "2", gig: "Summer Brunch Promo", opened_by: "@alexeats", opened_by_role: "influencer", against: "The Rooftop Cafe", reason: "Business didn't scan QR code", details: "I arrived at the venue on time and generated my QR. Waited 30 minutes but no staff came to scan. I had to leave.", status: "under_review", opened_at: "1d ago", assigned_admin: "Admin", resolution_notes: null },
  { id: "3", gig: "Weekend Tasting", opened_by: "Sakura Sushi", opened_by_role: "business", against: "@maya.jfood", reason: "Payout amount is incorrect", details: "The influencer was paid the full amount but we believe the content was AI-generated.", status: "resolved", opened_at: "3d ago", assigned_admin: "Admin", resolution_notes: "Investigated content — confirmed authentic. No payout adjustment. Warned business about unfounded claims." },
];
                  ...
                  {isExpanded && (
                    <div className="animate-fade-up border-t border-border px-4 pb-4 pt-3 space-y-4">
                      ...
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-muted-foreground">{d.against}</span>
                      </div>

                      {/* Details */}
                      <Card className="bg-muted/50">
                        <CardContent className="p-3">
                          <div className="font-display text-[11px] font-semibold uppercase text-muted-foreground">Details</div>

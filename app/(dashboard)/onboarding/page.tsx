        ...
        {roles.map((r) => (
          ...
          >
            <CardContent className="flex items-start gap-3.5 p-5">
              ...
              <ChevronRight className="mt-1 h-5 w-5 flex-shrink-0 text-slate-500/40" />
            </CardContent>
          </Card>
        ))}
      </div>
    ...
    <div className="px-6 lg:px-0">
      ...
      <div className="mt-5">
        ...
        <div className="mt-2 grid grid-cols-3 gap-2">
          {["MVR 750", "MVR 1,500", "MVR 3,750"].map((amt) => (
            <button
              key={amt}
              ...
              <div
                className={`flex h-9 w-9 items-center justify-center rounded-[10px] font-display text-sm font-extrabold ${
                  t.active
                    ...
                    : "border-2 border-border/50 text-slate-500"
                }`}
              >
                {t.n}
              </div>
      ...
      <Card className="mt-6 bg-muted/50">
        <CardContent className="p-4">
          <div className="mb-2 flex items-center justify-between">
            ...
            <span className="text-[13px] text-slate-500">0 / 2 gigs</span>
          </div>
...
function ReadyStep({ role }: { role: UserRole }) {
  ...
  return (
    <div className="flex flex-col items-center px-6 pt-16 text-center lg:px-0 lg:pt-0">
      ...
      <p className="mt-2 max-w-[300px] text-[15px] leading-relaxed text-slate-500">
        {role === "business"
        ...
        {statuses.map((s) => (
          <Card key={s.label} className="min-w-[80px] text-center">
            <CardContent className="p-3">
              ...
              <div className="mt-1 font-display text-[11px] font-semibold text-slate-500">
                {s.label}
              </div>

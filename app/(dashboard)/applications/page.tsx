...
const initialApplicants: Applicant[] = [
  { id: "1", name: "Yaania", handle: "@yaania", avatar: "YA", tier: 2, followers: "12.4K", engagement: "4.2%", platform: "Instagram", rating: 4.8, ratingCount: 12, status: "applied" },
  { id: "2", name: "Yuin", handle: "@yuin", avatar: "YU", tier: 2, followers: "8.7K", engagement: "5.1%", platform: "TikTok", rating: 4.5, ratingCount: 7, status: "applied" },
  { id: "3", name: "Bathool", handle: "@bathool", avatar: "BA", tier: 1, followers: "3.2K", engagement: "6.8%", platform: "Instagram", rating: 4.9, ratingCount: 3, status: "applied" },
  { id: "4", name: "Hanaan", handle: "@hanaan", avatar: "HA", tier: 3, followers: "45K", engagement: "3.4%", platform: "YouTube", rating: 4.7, ratingCount: 22, status: "applied" },
];
      ...
      <div className="w-full max-w-[560px] pb-16">
        ...
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Weekend Brunch Feature · Manual Review
          </p>
          <div className="mt-3 flex items-center gap-3">
            <Badge variant="secondary" className="gap-1 rounded-full font-display shadow-none">
              <Users className="h-3 w-3" />
              {accepted}/{maxSlots} accepted
            </Badge>
            <Badge variant="secondary" className="rounded-full font-display shadow-none">

...
const mockGigs: ActiveGig[] = [
  { id: "1", title: "Summer Brunch Promo", influencer: "Sarah Chen", handle: "@sarah.creates" },
  { id: "2", title: "Weekend Tasting Menu", influencer: "Sarah Chen", handle: "@sarah.creates" },
];
      ...
      <div className="w-full max-w-[420px] pb-16">
        ...
        {state === "ready" && (
          <div className="space-y-6 text-center">
            ...
            <div className="flex gap-2 rounded-lg bg-muted p-3 text-left text-xs text-muted-foreground">
              <MapPin className="mt-0.5 h-4 w-4 flex-shrink-0 text-muted-foreground" />
              <span>
                GPS will auto-match to your nearest outlet:{" "}
                <strong className="text-foreground">The Rooftop Cafe — Main St</strong>
              </span>
            </div>
            ...
            <div className="space-y-2">
              {mockGigs.map((g) => (
                <Card
                  key={g.id}
                  onClick={() => selectGig(g)}
                  className="cursor-pointer border-2 transition-all hover:border-primary/40 hover:shadow-md"
                >
            ...
            <Card className="border-emerald-200 bg-emerald-50/50 text-left">
              <CardContent className="space-y-2 p-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-medium">Main St Location</span>
                </div>
              </CardContent>
            </Card>
        ...
        {state === "expired" && (
          <div className="space-y-5 text-center">
            ...
            <div>
              <h1 className="font-display text-xl font-extrabold tracking-tight text-red-800">
                QR Expired
              </h1>
              <p className="mt-2 text-sm text-muted-foreground">

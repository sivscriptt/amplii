  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-1.5">
        ...
        <Input
          placeholder="e.g., Summer Brunch Feature"
          value={data.title}
      ...
      <Button
        onClick={onNext}
        disabled={!valid}
        className="h-11 w-full font-display font-semibold lg:h-10"
      >
        Continue
...
function RewardStep({
  ...
  const baseAmount = ((data.budget_total * data.base_percent) / 100).toFixed(2);
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="h-11 pl-9 font-mono text-base lg:h-10 lg:text-sm"
              />
            </div>
          </div>
        ...
        <div className="flex gap-2">
          {([1, 2, 3] as const).map((t) => (
            <button
              ...
              className={`flex-1 rounded-lg border-[1.5px] py-2.5 font-display text-sm font-bold transition-all ${
...
function ReviewStep({
  ...
  const rows: { label: string; value: string }[] = [
    ...
    ...(data.reward_type === "paid"
      ? [
          { label: "Budget / Influencer", value: `$${data.budget_total}` },
          ...
          <CardContent className="flex items-center gap-3 p-4">
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-amber-700">
                ${totalCost} will be held from your wallet ({data.max_slots}{" "}
                slots × ${data.budget_total})
              </div>
            </div>
        ...
        <DialogContent className="sm:max-w-[420px]">
          <DialogHeader>
            ...
            <DialogDescription>
              {data.reward_type === "paid" ? (
                <>
                  ${totalCost} will be deducted from your wallet and held in

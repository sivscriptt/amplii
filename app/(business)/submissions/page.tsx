...
const mockSubmissions: Submission[] = [
  { id: "1", influencer: "Sarah Chen", handle: "@sarah.creates", avatar: "SC", gig: "Summer Brunch Promo", path_type: "content", content_url: "https://instagram.com/reel/abc123", feedback_summary: null, review_status: "submitted", submitted_at: "2h ago", resubmission_count: 0 },
  { id: "2", influencer: "Alex Rivera", handle: "@alexeats", avatar: "AR", gig: "Summer Brunch Promo", path_type: "feedback", content_url: null, feedback_summary: "Food was great but wait time was over 40 minutes. Service needs improvement for influencer visits.", review_status: "submitted", submitted_at: "5h ago", resubmission_count: 0 },
  { id: "3", influencer: "Maya Johnson", handle: "@maya.jfood", avatar: "MJ", gig: "Weekend Tasting", path_type: "content", content_url: "https://tiktok.com/@maya/video/456", feedback_summary: null, review_status: "approved", submitted_at: "1d ago", resubmission_count: 0 },
  { id: "4", influencer: "Jordan Park", handle: "@jordanpark", avatar: "JP", gig: "Summer Brunch Promo", path_type: "content", content_url: "https://instagram.com/reel/xyz", feedback_summary: null, review_status: "rejected", submitted_at: "2d ago", resubmission_count: 1 },
];
                ...
                {selected.path_type === "content" && selected.content_url && (
                  <Card className="bg-muted/50">
                    <CardContent className="space-y-3 p-4">
                      <div className="font-display text-xs font-semibold uppercase text-muted-foreground">
                        Content Link
                      </div>
                      <a

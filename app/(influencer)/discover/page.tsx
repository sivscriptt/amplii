...
const mockGigs: Gig[] = [
  { id: "1", title: "Summer Brunch Feature", business: "The Rooftop Cafe", business_avatar: "RC", business_rating: 4.6, distance: "0.3 mi", reward_type: "paid", budget: 100, base_percent: 30, barter_desc: "", audience_offer: "10% off brunch", tier_required: 1, slots_filled: 1, max_slots: 3, deadline_days: 7, platforms: ["Instagram Reels", "TikTok"], description: "Visit our rooftop brunch and share your experience with your followers." },
  { id: "2", title: "Spa Day Review", business: "Serenity Spa", business_avatar: "SS", business_rating: 4.8, distance: "0.8 mi", reward_type: "barter", budget: 0, base_percent: 0, barter_desc: "Full spa treatment package", audience_offer: "15% off first visit", tier_required: 2, slots_filled: 0, max_slots: 2, deadline_days: 5, platforms: ["Instagram Reels"], description: "Experience our signature treatment and create authentic content." },
  { id: "3", title: "New Menu Tasting", business: "Sakura Sushi", business_avatar: "SK", business_rating: 4.4, distance: "1.2 mi", reward_type: "free", budget: 0, base_percent: 0, barter_desc: "", audience_offer: "Free appetizer", tier_required: 1, slots_filled: 1, max_slots: 5, deadline_days: 14, platforms: ["TikTok", "YouTube Shorts"], description: "Try our new seasonal menu and share your honest reaction." },
  { id: "4", title: "Grand Opening Coverage", business: "Belle Boutique", business_avatar: "BB", business_rating: 4.9, distance: "2.1 mi", reward_type: "paid", budget: 200, base_percent: 25, barter_desc: "", audience_offer: "BOGO accessories", tier_required: 3, slots_filled: 0, max_slots: 2, deadline_days: 3, platforms: ["Instagram Reels", "TikTok", "YouTube Shorts"], description: "Cover our grand opening event — exclusive first look for your audience." },
];
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-2 flex flex-wrap gap-1.5">
                        <Badge className={`gap-1 text-[10px] ${REWARD_STYLES[g.reward_type]}`}>
                          ...
                          {g.reward_type === "paid" ? `$${g.budget}` : g.reward_type === "barter" ? "Barter" : "Free"}
                        </Badge>
                        {g.reward_type === "paid" && (
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <Card className="bg-muted/50"><CardContent className="p-3">
                    <div className="font-display text-[11px] font-semibold uppercase text-muted-foreground">Reward</div>
                    <div className="mt-1 text-sm font-bold">
                      {selected.reward_type === "paid" ? `$${selected.budget}` : selected.reward_type === "barter" ? selected.barter_desc : "Free (exposure)"}
                    </div>
                  </CardContent></Card>
                  {selected.reward_type === "paid" && (
                    <Card className="bg-muted/50"><CardContent className="p-3">
                      <div className="font-display text-[11px] font-semibold uppercase text-muted-foreground">Split</div>
                  ...
                  <Card className="bg-muted/50"><CardContent className="p-3">
                    <div className="font-display text-[11px] font-semibold uppercase text-muted-foreground">Deadline</div>
                    <div className="mt-1 text-sm font-bold">{selected.deadline_days} days</div>
                  </CardContent></Card>
                  <Card className="bg-muted/50"><CardContent className="p-3">
                    <div className="font-display text-[11px] font-semibold uppercase text-muted-foreground">Slots</div>
